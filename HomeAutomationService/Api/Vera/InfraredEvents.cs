...
{
    internal class InfraredEvents : InfraredCommands
    {
        public static void TVOn(object sender, DoWorkEventArgs e)
        {
            ...
            {
                Thread.Sleep(2000);
                InfraredController.Send(ProntoDeviceActions.TVOn);
        ...
        public static void TVOff(object sender, DoWorkEventArgs e)
        {
            ...
            {
                Thread.Sleep(2000);
                InfraredController.Send(ProntoDeviceActions.TVOff);
        ...
        public static void FireplaceOn(object sender, DoWorkEventArgs e)
        {
            ...
            {
                Thread.Sleep(2000);
                InfraredController.Send(ProntoDeviceActions.FireplaceOff);
                Thread.Sleep(3000);
                InfraredController.Send(ProntoDeviceActions.FireplaceOn);
                Thread.Sleep(5000);
                InfraredController.Send(ProntoDeviceActions.FireplaceOn);
                Thread.Sleep(5000);
                InfraredController.Send(ProntoDeviceActions.FireplaceOn);
